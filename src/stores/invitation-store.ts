...
export class InvitationStore {
  ...
  constructor() {
    makeObservable(this, {
      uid: observable,
      connectionRef: observable,
      onlineUsers: observable,
      statistics: observable,
      getStatisticsInfo: action.bound,
      onNewInvitation: action.bound,
      onDeleteInvitation: action.bound,
      setOnlineUsers: action.bound,
      setUser: action.bound,
      setInvitations: action.bound,
      sendInvite: action.bound,
      acceptInvitation: action.bound,
      createGame: action.bound,
      rejectInvitation: action.bound,
      rematch: action.bound
    })
...
/*
  ...
  async setOnlineUsers(users: any) {
    if (users == null) {
  ...
  async setInvitations(_invitations:any) {
    if (_invitations == null) {
      this.invitations = []
      return
    }

    this.invitations = Object.keys(_invitations).map(key => _invitations[key]) as []
  }
