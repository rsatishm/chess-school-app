import { Table, Switch, Radio, Form, Space, TablePaginationConfig } from 'antd';
...
export class AntdTableDynamicSettings extends React.Component {
  state = {
    bordered: false,
    loading: false,
    pagination,
  ...
  render() {
    ...
    const tableColumns: any[] = columns.map(item => ({ ...item, ellipsis: state.ellipsis }));
    if (xScroll === 'fixed') {
      tableColumns[0].fixed = true;
      tableColumns[tableColumns.length - 1].fixed = 'right';
    }
    const pos : TablePaginationPosition[] = [this.state.top, this.state.bottom] as TablePaginationPosition[]
