...
export class AntdModalDark extends React.Component {
  state = {
    visible: false,
    ...
    return (
      <>
        ...
        >
          ...
          <Table columns={columns as any} dataSource={data} footer={() => 'Footer'} />
          <Table
          ...
          <Table columns={columnsFixed as any} dataSource={dataFixed} scroll={{ x: 1300, y: 100 }} />
          <Card
            hoverable
            style={{ width: 240 }}
            cover={
